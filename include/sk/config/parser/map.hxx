...
#ifndef SK_CONFIG_PARSER_MAP_HXX_INCLUDED
#define SK_CONFIG_PARSER_MAP_HXX_INCLUDED
...
namespace sk::config {
    ...
    namespace detail {
        ...
        void propagate_value(auto &ctx, std::map<T, U> &to, U &from,
                             auto &name) {
...
#endif // SK_CONFIG_PARSER_MAP_HXX_INCLUDED
